...
<main class="wp-block-group"
	...
	<div class="wp-block-group has-primary-background-color has-background"
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|light"}}}},"textColor":"light","fontSize":"normal"} -->
			<p class="has-light-color has-text-color has-link-color has-normal-font-size"><?php esc_html_e( '2345 Beach,Rd Metrocity USA, HWY 1235 | +1 (000) 012-3456', 'grocefycart' ); ?></p>
			<!-- /wp:paragraph -->
	...
	<div class="wp-block-group is-style-grocefycart-boxshadow-light"
		...
		<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
		<div class="wp-block-group"
