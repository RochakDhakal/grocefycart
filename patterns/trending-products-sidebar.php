...
<div class="wp-block-group"
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		$grocefycart_product_img = array(
			...
			$grocefycart_product_url . 'assets/images/product-cart.jpg',
					...
					<div class="wp-block-group">
								...
								<div class="wp-block-group"
									...
									<figure class="wp-block-image size-full is-resized"
										style="margin-top:0;margin-right:0;margin-bottom:0px;margin-left:0"><img
											src="<?php echo esc_url( $grocefycart_product_img[8] ); ?>" alt=""
											class="wp-image-1423" style="object-fit:contain;width:60px;height:24px" />
									</figure>
									<!-- /wp:image -->
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<h4 class="wp-block-heading has-heading-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:0;margin-bottom:0;line-height:1.2">
									<?php esc_html_e( 'Farfalle', 'grocefycart' ); ?>
								</h4>
								<!-- /wp:heading -->
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="<?php echo esc_url( $grocefycart_product_img[3] ); ?>" alt="" class="wp-image-66"
										style="aspect-ratio:1;object-fit:cover;width:auto;height:64px" /></figure>
								<!-- /wp:image -->
							</div>
							<!-- /wp:column -->
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<h4 class="wp-block-heading has-heading-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:0;margin-bottom:0;line-height:1.2">
									<?php esc_html_e( 'Strawberry', 'grocefycart' ); ?>
								</h4>
								<!-- /wp:heading -->
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="<?php echo esc_url( $grocefycart_product_img[4] ); ?>" alt="" class="wp-image-76"
										style="aspect-ratio:1;object-fit:cover;width:auto;height:64px" /></figure>
								<!-- /wp:image -->
							</div>
							<!-- /wp:column -->
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<h4 class="wp-block-heading has-heading-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:0;margin-bottom:0;line-height:1.2">
									<?php esc_html_e( 'Pomegranate', 'grocefycart' ); ?>
								</h4>
								<!-- /wp:heading -->
								...
								<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:5px;margin-bottom:0px;font-style:normal;font-weight:600">
									<?php esc_html_e( '$49.99', 'grocefycart' ); ?>
								</h2>
								<!-- /wp:heading -->
							</div>
							<!-- /wp:column -->
					...
					<div class="wp-block-columns"><!-- wp:column {"width":"33.34%"} -->
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="<?php echo esc_url( $grocefycart_product_img[0] ); ?>" alt="" class="wp-image-59"
								...
								<figure class="wp-block-image size-full is-resized" style="margin-top:0;margin-bottom:0">
									<img src="<?php echo esc_url( $grocefycart_product_img[8] ); ?>" alt=""
										class="wp-image-1423" style="width:auto;height:24px" />
								</figure>
								<!-- /wp:image -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<div class="wp-block-group"
									...
									<p class="has-heading-color has-secondary-background-color has-text-color has-background has-link-color has-x-small-font-size"
										style="border-radius:100px;padding-top:4px;padding-right:12px;padding-bottom:4px;padding-left:12px;font-style:normal;font-weight:500">
										<?php esc_html_e( 'Add To Cart', 'grocefycart' ); ?>
									</p>
									<!-- /wp:paragraph -->
								</div>
								<!-- /wp:group -->
								...
								<h6 class="wp-block-heading has-heading-color has-text-color has-link-color has-normal-font-size"
									style="margin-top:14px;margin-right:0;margin-bottom:14px;margin-left:0;font-style:normal;font-weight:600">
									<?php esc_html_e( 'Wine Collection', 'grocefycart' ); ?>
								</h6>
								<!-- /wp:heading -->
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												style="background-color:rgba(0, 0, 0, 0)"
												class="has-inline-color has-foreground-color"><?php esc_html_e( '$99.99', 'grocefycart' ); ?></mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color"><?php esc_html_e( '$89.99', 'grocefycart' ); ?></mark>
									</h2>
									<!-- /wp:heading -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<h6 class="wp-block-heading has-heading-color has-text-color has-link-color has-normal-font-size"
									style="margin-top:14px;margin-right:0;margin-bottom:14px;margin-left:0;font-style:normal;font-weight:600">
									<?php esc_html_e( 'Mix Fruit Cart', 'grocefycart' ); ?>
								</h6>
								<!-- /wp:heading -->
					...
					<div class="wp-block-columns"><!-- wp:column {"width":"33.34%"} -->
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<h6 class="wp-block-heading has-heading-color has-text-color has-link-color has-normal-font-size"
									style="margin-top:14px;margin-right:0;margin-bottom:14px;margin-left:0;font-style:normal;font-weight:600">
									<?php echo esc_url( $grocefycart_product_img[7] ); ?>
								</h6>
								<!-- /wp:heading -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<h6 class="wp-block-heading has-heading-color has-text-color has-link-color has-normal-font-size"
									style="margin-top:14px;margin-right:0;margin-bottom:14px;margin-left:0;font-style:normal;font-weight:600">
									<?php esc_html_e( 'Tagliate Pasta', 'grocefycart' ); ?>
								</h6>
								<!-- /wp:heading -->
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image size-full is-resized" style="margin-top:0;margin-bottom:0">
									<img src="<?php echo esc_url( $grocefycart_product_img[8] ); ?>"
										alt="" class="wp-image-1423" style="width:auto;height:24px" />
								</figure>
								<!-- /wp:image -->
