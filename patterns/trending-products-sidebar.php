		...
		<div class="wp-block-columns"><!-- wp:column {"width":"25%"} -->
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<figure
					...
					<img src="http://localhost/wordpress/grocefy-cart/wp-content/themes/grocefycart/assets/images/ads.jpg"
					...
					<div class="wp-block-woocommerce-product-collection">
						...
						<div class="wp-block-group"
							...
							<h4 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color has-big-font-size"
								...
								<?php esc_html_e( 'Trending Products', 'grocefycart' ); ?>
							</h4>
							<!-- /wp:heading -->
						...
						<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color has-heading-color has-text-color has-link-color"
							...
							<!-- wp:woocommerce/product-image {"saleBadgeAlign":"left","isDescendentOfQueryLoop":true,"width":"","height":"150px","className":"is-style-default","style":{"spacing":{"padding":{"top":"10px","bottom":"10px","left":"10px","right":"10px"}}}} /-->
		...
		<div class="wp-block-columns"><!-- wp:column {"width":"25%"} -->
			<div class="wp-block-column" style="flex-basis:25%">
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/product-penne.jpg"
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<h4 class="wp-block-heading has-heading-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:0;margin-bottom:0;line-height:1.2">
									Penne Rigate </h4>
								<!-- /wp:heading -->
								...
								<div class="wp-block-group"
									...
									<figure class="wp-block-image size-full is-resized"
										style="margin-top:0;margin-right:0;margin-bottom:0px;margin-left:0"><img
											src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/star.png"
									...
									<div class="wp-block-group">
										...
										<p class="has-primary-color has-text-color has-background has-link-color"
											style="border-radius:100px;background-color:#1d8d601a;padding-top:4px;padding-right:12px;padding-bottom:4px;padding-left:12px;font-size:10px">
											In stock</p>
										<!-- /wp:paragraph -->
									</div>
									<!-- /wp:group -->
								...
								<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-small-plus-font-size"
									style="margin-top:5px;margin-bottom:0px;font-style:normal;font-weight:600">
									$29.99 </h2>
								<!-- /wp:heading -->
							</div>
							<!-- /wp:column -->
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/product-farfalle.jpg"
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/product-berry-1.jpg"
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<div class="wp-block-group"
									style="margin-top:5px;margin-bottom:5px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
									<!-- wp:image {"id":1423,"width":"60px","height":"12px","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"spacing":{"margin":{"top":"0","bottom":"12px","left":"0","right":"0"}},"layout":{"selfStretch":"fit","flexSize":null}}} -->
									<figure class="wp-block-image size-full is-resized"
										style="margin-top:0;margin-right:0;margin-bottom:12px;margin-left:0"><img
											src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/star.png"
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								<!-- wp:image {"id":59,"width":"auto","height":"64px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"center"} -->
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/product-tagliate.jpg"
										alt="penne" class="wp-image-59"
										style="aspect-ratio:1;object-fit:cover;width:auto;height:64px" /></figure>
								<!-- /wp:image -->
							</div>
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<div class="wp-block-group"
									...
									<div class="wp-block-group">
										...
										<p class="has-primary-color has-text-color has-background has-link-color"
											style="border-radius:100px;background-color:#1d8d601a;margin-top:0;margin-bottom:0;padding-top:4px;padding-right:12px;padding-bottom:4px;padding-left:12px;font-size:10px">
											In stock</p>
										<!-- /wp:paragraph -->
									</div>
									<!-- /wp:group -->
						...
						<div class="wp-block-columns is-not-stacked-on-mobile">
							...
							<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
								...
								<figure class="wp-block-image aligncenter size-full is-resized"><img
										src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/product-pomegranate.jpg"
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<div class="wp-block-group"
									style="margin-top:5px;margin-bottom:5px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
									<!-- wp:image {"id":1423,"width":"60px","height":"12px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"spacing":{"margin":{"top":"0","bottom":"12px","left":"0","right":"0"}},"layout":{"selfStretch":"fit","flexSize":null}}} -->
									<figure class="wp-block-image size-full is-resized"
										style="margin-top:0;margin-right:0;margin-bottom:12px;margin-left:0"><img
											src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/star.png"
											alt="" class="wp-image-1423"
											style="object-fit:contain;width:60px;height:12px" /></figure>
									<!-- /wp:image -->
				...
				<figure class="wp-block-image aligncenter size-full is-resized has-custom-border"><img
						src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/ads.jpg" alt=""
						class="wp-image-452"
			...
			<div class="wp-block-column" style="flex-basis:75%">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group"
						...
						<h4 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color has-big-font-size"
							style="border-bottom-style:none;border-bottom-width:0px;margin-bottom:0">
					...
					<div class="wp-block-columns"><!-- wp:column {"width":"33.34%"} -->
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<h6 class="wp-block-heading has-heading-color has-text-color has-link-color has-normal-font-size"
									style="margin-top:14px;margin-right:0;margin-bottom:14px;margin-left:0;font-style:normal;font-weight:600">
									Penne Rigate</h6>
								<!-- /wp:heading -->
								...
								<figure class="wp-block-image size-full is-resized" style="margin-top:0;margin-bottom:0">
									<img src="http://localhost/wordpress-test/wp-content/themes/grocefycart/assets/images/star.png"
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												...
												class="has-inline-color has-foreground-color">$49.99 </mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">$39.99</mark></h2>
									<!-- /wp:heading -->
									...
									<div class="wp-block-buttons">
										...
										<div
											...
											<a class="wp-block-button__link has-primary-color has-text-color has-background has-link-color wp-element-button"
												style="border-radius:100px;background-color:#1d8d601a;padding-top:12px;padding-right:14px;padding-bottom:12px;padding-left:14px">Add
												To Cart</a></div>
										<!-- /wp:button -->
									</div>
									<!-- /wp:buttons -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="http://localhost/wordpress-test/wp-content/uploads/2025/03/product-wine.jpg"
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												style="background-color:rgba(0, 0, 0, 0)"
												class="has-inline-color has-foreground-color">$99.99 </mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">8</mark><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">9.99</mark></h2>
									<!-- /wp:heading -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="http://localhost/wordpress-test/wp-content/uploads/2025/03/product-mix.jpg"
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												style="background-color:rgba(0, 0, 0, 0)"
												class="has-inline-color has-foreground-color">$69.99 </mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">$49.99</mark></h2>
									<!-- /wp:heading -->
					...
					<div class="wp-block-columns"><!-- wp:column {"width":"33.34%"} -->
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="http://localhost/wordpress-test/wp-content/uploads/2025/03/product-berry.jpg"
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="http://localhost/wordpress-test/wp-content/uploads/2025/03/product-tagliate.jpg"
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												style="background-color:rgba(0, 0, 0, 0)"
												class="has-inline-color has-foreground-color">$39.99 </mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">2</mark><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">9.99</mark></h2>
									<!-- /wp:heading -->
						...
						<div class="wp-block-column" style="flex-basis:33.34%">
							...
							<div class="wp-block-group is-style-grocefycart-boxshadow-hover has-border-color"
								...
								<figure class="wp-block-image aligncenter size-full is-resized"
									style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img
										src="http://localhost/wordpress-test/wp-content/uploads/2025/03/product-farfalle-1.jpg"
								...
								<div class="wp-block-group"
									...
									<h2 class="wp-block-heading has-small-plus-font-size"><s><mark
												style="background-color:rgba(0, 0, 0, 0)"
												class="has-inline-color has-foreground-color">$29.99 </mark></s><mark
											style="background-color:rgba(0, 0, 0, 0)"
											class="has-inline-color has-primary-color">$19.99</mark></h2>
									<!-- /wp:heading -->
