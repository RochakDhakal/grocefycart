				...
				<div class="wp-block-query"><!-- wp:post-template -->
					...
					<div class="wp-block-cover is-light has-custom-content-position is-position-center-left"
						...
						<div class="wp-block-cover__inner-container">
							...
							<div class="wp-block-group">
								<!-- wp:post-terms {"term":"product_cat","className":"is-style-categories-background-with-round","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"textTransform":"uppercase"}},"textColor":"background","fontSize":"x-small"} /-->
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-group has-border-color"
					...
					<div class="wp-block-group has-small-plus-font-size"
						style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;margin-top:0;margin-bottom:15px;padding-bottom:15px;font-style:normal;font-weight:500">
						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
						<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size">Frozen Seafoods
						</p>
						<!-- /wp:paragraph -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;margin-top:0;margin-bottom:15px;padding-bottom:15px;font-style:normal;font-weight:500">
						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
						<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size">Milk and Diaries
						</p>
						<!-- /wp:paragraph -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;margin-top:0;margin-bottom:15px;padding-bottom:15px;font-style:normal;font-weight:500">
						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
						<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size">Wines &amp;
							Drinks</p>
						<!-- /wp:paragraph -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;margin-top:0;margin-bottom:15px;padding-bottom:15px;font-style:normal;font-weight:500">
						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
						<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size">Coffee &amp; Tea
						</p>
						<!-- /wp:paragraph -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;margin-top:0;margin-bottom:15px;padding-bottom:15px;font-style:normal;font-weight:500">
						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
						<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size">Food Cupboard
						</p>
						<!-- /wp:paragraph -->
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<div class="wp-block-cover is-light has-custom-content-position is-position-center-left"
					style="border-radius:10px;padding-right:55px;padding-left:55px;min-height:500px"><span
						...
						alt=""
						src="http://localhost/wordpress/grocefy-cart/wp-content/uploads/sites/5/2025/02/Mask-group-2.jpg"
						data-object-fit="cover" />
					<div class="wp-block-cover__inner-container">
						<!-- wp:group {"layout":{"type":"constrained","justifyContent":"left","contentSize":"420px"}} -->
						<div class="wp-block-group"><!-- wp:buttons -->
							<div class="wp-block-buttons">
								<!-- wp:button {"backgroundColor":"Terniary","className":"is-style-button-hover-primary-bgcolor","style":{"border":{"radius":"100px"},"typography":{"textTransform":"uppercase"}},"fontSize":"x-small"} -->
								<div class="wp-block-button has-custom-font-size is-style-button-hover-primary-bgcolor has-x-small-font-size"
									style="text-transform:uppercase"><a
										...
										style="border-radius:100px">Juicy</a></div>
								<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
							...
							<h1 class="wp-block-heading has-large-plus-font-size"
								style="margin-top:16px;margin-right:0;margin-bottom:16px;margin-left:0;line-height:1.2">
								Healthy Vegetable Drinks</h1>
							<!-- /wp:heading -->
							...
							<h4 class="wp-block-heading has-primary-color has-text-color has-link-color"
								style="text-transform:uppercase">From $1.99-$2.99</h4>
							<!-- /wp:heading -->
							...
							<div class="wp-block-buttons" style="margin-top:34px;margin-bottom:0">
								<!-- wp:button {"backgroundColor":"light","textColor":"primary","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"border":{"radius":"100px"},"spacing":{"padding":{"left":"28px","right":"28px","top":"12px","bottom":"12px"}}},"fontSize":"small-plus"} -->
								<div class="wp-block-button has-custom-font-size has-small-plus-font-size"><a
										...
										style="border-radius:100px;padding-top:12px;padding-right:28px;padding-bottom:12px;padding-left:28px">Shop
										Now</a></div>
								<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-cover is-light has-custom-content-position is-position-top-left"
					...
					<span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"
						...
						alt=""
						src="http://localhost/wordpress/grocefy-cart/wp-content/uploads/sites/5/2025/02/Mask-group-4-1.jpg"
						data-object-fit="cover" />
					<div class="wp-block-cover__inner-container">
						<!-- wp:group {"layout":{"type":"constrained","justifyContent":"left","contentSize":"170px"}} -->
						<div class="wp-block-group"><!-- wp:buttons -->
							<div class="wp-block-buttons">
								<!-- wp:button {"backgroundColor":"Terniary","className":"is-style-button-hover-primary-bgcolor","style":{"border":{"radius":"100px"},"typography":{"textTransform":"uppercase"},"spacing":{"padding":{"left":"12px","right":"12px","top":"5px","bottom":"5px"}}},"fontSize":"x-small"} -->
								<div class="wp-block-button has-custom-font-size is-style-button-hover-primary-bgcolor has-x-small-font-size"
									style="text-transform:uppercase"><a
										class="wp-block-button__link has-terniary-background-color has-background wp-element-button"
										style="border-radius:100px;padding-top:5px;padding-right:12px;padding-bottom:5px;padding-left:12px">Juicy</a>
								</div>
								<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
							...
							<div class="wp-block-buttons" style="margin-top:13px;margin-bottom:0">
								...
								<div class="wp-block-button has-custom-font-size has-small-plus-font-size"><a
										class="wp-block-button__link has-primary-color has-light-background-color has-text-color has-background has-link-color wp-element-button"
										style="border-radius:100px;padding-top:8px;padding-right:14px;padding-bottom:8px;padding-left:14px">Shop
										Now</a></div>
								<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
				...
				<div class="wp-block-cover is-light has-custom-content-position is-position-top-left"
					...
					<span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"
						...
						alt=""
						src="http://localhost/wordpress/grocefy-cart/wp-content/uploads/sites/5/2025/02/Mask-group-6-1.jpg"
						data-object-fit="cover" />
					<div class="wp-block-cover__inner-container">
						<!-- wp:group {"layout":{"type":"constrained","justifyContent":"left","contentSize":"170px"}} -->
						<div class="wp-block-group"><!-- wp:buttons -->
