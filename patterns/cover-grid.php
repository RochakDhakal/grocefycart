				...
				<div class="wp-block-query"><!-- wp:post-template -->
					...
					<div class="wp-block-cover is-light has-custom-content-position is-position-center-left is-style-grocefycart-hover-zoom-in"
						...
						<span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"
							...
							src="<?php echo esc_url( $grocefycart_cover_img[2] ); ?>" data-object-fit="cover" />
						<div class="wp-block-cover__inner-container">
							<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"170px","justifyContent":"left"}} -->
							<div class="wp-block-group">
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-group has-border-color"
					...
					<h5 class="wp-block-heading has-heading-color has-text-color has-link-color has-medium-font-size"
						style="border-bottom-color:var(--wp--preset--color--primary);border-bottom-width:1px;margin-bottom:30px;padding-bottom:10px;font-style:normal;font-weight:600"><?php esc_html_e( 'Top Categories', 'grocefycart' ); ?></h5>
					<!-- /wp:heading -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[0] ); ?>" alt=""
									class="wp-image-91" style="aspect-ratio:1;object-fit:cover;width:30px" /></figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Fruits & Vegetable', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(9)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[1] ); ?>"
									alt="" class="wp-image-99" style="aspect-ratio:1;object-fit:cover;width:30px" />
							</figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Pet Foods', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(4)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[2] ); ?>" alt=""
									class="wp-image-100" style="aspect-ratio:1;object-fit:cover;width:30px" /></figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Frozen Seafoods', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(6)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[3] ); ?>"
									alt="" class="wp-image-101" style="aspect-ratio:1;object-fit:cover;width:30px" />
							</figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Dairy Products', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(5)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[4] ); ?>" alt=""
									class="wp-image-103" style="aspect-ratio:1;object-fit:cover;width:30px" /></figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Alcohol', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(8)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[5] ); ?>"
									alt="" class="wp-image-104" style="aspect-ratio:1;object-fit:cover;width:30px" />
							</figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Coffee & Tea', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(10)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group has-small-plus-font-size"
						...
						<div class="wp-block-group">
							...
							<figure class="wp-block-image size-full is-resized"><img
									src="<?php echo esc_url( $grocefycart_cat_img[6] ); ?>" alt=""
									class="wp-image-105" style="aspect-ratio:1;object-fit:cover;width:30px" /></figure>
							<!-- /wp:image -->

							<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"small-plus"} -->
							<p class="has-heading-color has-text-color has-link-color has-small-plus-font-size"><?php esc_html_e( 'Food Cupboard', 'grocefycart' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} -->
						<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '(3)', 'grocefycart' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
					...
					<div class="wp-block-cover__inner-container">
						...
						<div class="wp-block-group"><!-- wp:buttons -->
							...
							<h1 class="wp-block-heading is-style-title-hover-primary has-heading-color has-text-color has-link-color has-large-plus-font-size"
								style="margin-top:16px;margin-bottom:16px;font-style:normal;font-weight:600;line-height:1.2"><?php esc_html_e( 'Healthy Vegetable Drinks', 'grocefycart' ); ?></h1>
							<!-- /wp:heading -->
							...
							<h4 class="wp-block-heading has-primary-color has-text-color has-link-color has-medium-font-size"
								style="font-style:normal;font-weight:700;text-transform:uppercase"><?php esc_html_e( 'From $1.99-$2.99', 'grocefycart' ); ?></h4>
							<!-- /wp:heading -->
							...
							<div class="wp-block-buttons" style="margin-top:34px;margin-bottom:0">
								...
								<div
									...
									<a class="wp-block-button__link has-primary-color has-light-background-color has-text-color has-background has-link-color wp-element-button"
										style="border-radius:100px;padding-top:12px;padding-right:28px;padding-bottom:12px;padding-left:28px"><?php esc_html_e( 'Shop Now', 'grocefycart' ); ?></a></div>
								<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
						</div>
			...
			<div class="wp-block-column" style="flex-basis:25%">
					...
					<div class="wp-block-cover__inner-container">
						...
						<div class="wp-block-group"><!-- wp:buttons -->
							...
							<h1 class="wp-block-heading has-heading-color has-text-color has-link-color"
								style="margin-top:10px;margin-bottom:10px;font-size:18px;font-style:normal;font-weight:600;line-height:1.2"><?php esc_html_e( 'Fresh Coconut Water', 'grocefycart' ); ?></h1>
							<!-- /wp:heading -->
				...
				<div class="wp-block-cover is-light has-custom-content-position is-position-center-left is-style-grocefycart-hover-zoom-in"
					...
					<span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"
						...
						alt="" src="<?php echo esc_url( $grocefycart_cover_img[2] ); ?>"
						data-object-fit="cover" />
					<div class="wp-block-cover__inner-container">
						...
						<div class="wp-block-group"><!-- wp:buttons -->
							...
							<!-- wp:heading {"level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"},":hover":{"color":{"text":"var:preset|color|primary"}}}},"spacing":{"margin":{"top":"10px","bottom":"10px"}},"typography":{"lineHeight":"1.2","fontStyle":"normal","fontWeight":"600","fontSize":"18px"}},"textColor":"heading"} -->
							<h1 class="wp-block-heading has-heading-color has-text-color has-link-color"
								style="margin-top:10px;margin-bottom:10px;font-size:18px;font-style:normal;font-weight:600;line-height:1.2"><?php esc_html_e( 'Nutritious Veggie Foods', 'grocefycart' ); ?></h1>
							<!-- /wp:heading -->
