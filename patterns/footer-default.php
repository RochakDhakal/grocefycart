...
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}},"backgroundColor":"background-alt","layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-group has-background-alt-background-color has-background"
	style="padding-top:0;padding-right:var(--wp--preset--spacing--0);padding-bottom:0;padding-left:var(--wp--preset--spacing--0)">
	<!-- wp:group {"style":{"spacing":{"padding":{"top":"90px","bottom":"165px","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1260px"}} -->
	<div class="wp-block-group"
		style="padding-top:90px;padding-bottom:165px;padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-columns"><!-- wp:column {"width":"16%"} -->
					<div class="wp-block-column" style="flex-basis:16%">
						...
						<div class="wp-block-group">
							...
							<!-- wp:navigation {"ref":1722,"overlayMenu":"never","className":"is-style-grocefycart-navigation-primary","style":{"spacing":{"padding":{"right":"1em","left":"1em"},"blockGap":"5px"},"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"normal","layout":{"type":"flex","orientation":"vertical","flexWrap":"wrap"}} -->
					...
					<div class="wp-block-column" style="flex-basis:16%">
						...
						<div class="wp-block-group">
							...
							<!-- wp:list {"className":"is-style-grocefycart-list-style-none","style":{"spacing":{"padding":{"right":"0","left":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"foreground","fontSize":"normal"} -->
							<ul style="padding-right:0;padding-left:0;font-style:normal;font-weight:500"
								...
								<li class="has-foreground-color has-text-color has-link-color has-normal-font-size">
									<?php esc_html_e( 'Contact Us', 'grocefycart' ); ?>
								</li>
								<!-- /wp:list-item -->
							</ul>
							<!-- /wp:list -->
						...
						<div class="wp-block-group">
							...
							<ul style="padding-right:0;padding-left:0;font-style:normal;font-weight:500"
								...
								<li style="margin-bottom:5px">
									<?php esc_html_e( 'Terms & Conditions', 'grocefycart' ); ?>
								</li>
								<!-- /wp:list-item -->
								...
								<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"5px"}}}} -->
								<li style="margin-bottom:5px"><?php esc_html_e( 'Privacy Policy', 'grocefycart' ); ?>
								</li>
								<!-- /wp:list-item -->

								<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"5px"}}}} -->
								<li style="margin-bottom:5px"><?php esc_html_e( 'Return Policy', 'grocefycart' ); ?>
								</li>
								<!-- /wp:list-item -->
	...
	<div class="wp-block-group"
		...
		<div class="wp-block-group" style="padding-right:0;padding-left:0">
			...
			<p class="has-light-color has-text-color has-link-color has-small-plus-font-size">
				<?php esc_html_e( 'Proudly powered by WordPress | GrocefyCart by CozyThemes.', 'grocefycart' ); ?></p>
			<!-- /wp:paragraph -->
